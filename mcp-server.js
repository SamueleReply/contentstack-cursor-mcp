                ...
                inputSchema: {
                    ...
                    properties: {
                        ...
                        version: {
                            nullable: true,
                            type: 'number',
                            description: 'Version number of the entry to publish, if not provided, the latest version will be published'
                        }
                    },
                ...
                inputSchema: {
                    ...
                    properties: {
                        ...
                        version: {
                            nullable: true,
                            type: 'number',
                            description: 'Version number of the entry to unpublish, if not provided, the latest version will be unpublished'
                        }
                    },
                    required: ['contentTypeUid', 'entryUid', 'entry', 'locale', 'version']
                }
